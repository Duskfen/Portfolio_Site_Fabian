...
/* harmony import */ var _img_Loading_gif__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(47);
...
/* harmony import */ var aos__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(48);
...
/* harmony import */ var _css_main_css__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(68);
...
/* harmony import */ var _css_project_overview_css__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(73);
...
/* harmony import */ var _img_logo_full_svg__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(49);
...
/* harmony import */ var aos_dist_aos_css__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(75);
...
var right_arrow = __webpack_require__(74);
...
var Project = function Project(information) {
  ...
  this.titleImage = __webpack_require__(76)("./".concat(information.path, "/main.jpg"));
  this.images = [];
  ...
  for (var i = 0; i < information.count_imgs; i++) {
    this.images.push(babel_plugin_universal_import_universalImport__WEBPACK_IMPORTED_MODULE_6___default()({
      id: "./projects//img/${i}.",
      load: function load() {
        return Promise.all([__webpack_require__(77)("./".concat(information.path, "/img/").concat(i, ".").concat(information.image_extention[i % information.image_extention.length]))]).then(function (proms) {
          return proms[0];
        });
      },
      path: function path() {
      ...
      resolve: function resolve() {
        return /*require.resolve*/(__webpack_require__(78).resolve("./".concat(information.path, "/img/").concat(i, ".").concat(information.image_extention[i % information.image_extention.length])));
      },
...
/* harmony import */ var _css_circle_css__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(79);
...
var Dynamic = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_7___default.a.lazy(function () {
  return babel_plugin_universal_import_universalImport__WEBPACK_IMPORTED_MODULE_6___default()({
    ...
    load: function load() {
      return Promise.all([Promise.resolve(/* import() | containers/Dynamic */).then(__webpack_require__.bind(null, 36))]).then(function (proms) {
        return proms[0];
      });
    },
    path: function path() {
...
var t_0 = react_universal_component__WEBPACK_IMPORTED_MODULE_3___default()(babel_plugin_universal_import_universalImport__WEBPACK_IMPORTED_MODULE_1___default()({
  ...
  load: function load() {
    return Promise.all([Promise.resolve(/* import() | __react_static_root__/src/components/404 */).then(__webpack_require__.bind(null, 33))]).then(function (proms) {
      return proms[0];
    });
  },
  path: function path() {
...
var t_1 = react_universal_component__WEBPACK_IMPORTED_MODULE_3___default()(babel_plugin_universal_import_universalImport__WEBPACK_IMPORTED_MODULE_1___default()({
  ...
  load: function load() {
    return Promise.all([Promise.resolve(/* import() | __react_static_root__/src/components/about */).then(__webpack_require__.bind(null, 34))]).then(function (proms) {
      return proms[0];
    });
  },
  path: function path() {
...
var t_2 = react_universal_component__WEBPACK_IMPORTED_MODULE_3___default()(babel_plugin_universal_import_universalImport__WEBPACK_IMPORTED_MODULE_1___default()({
  ...
  load: function load() {
    return Promise.all([Promise.resolve(/* import() | __react_static_root__/src/components/branding */).then(__webpack_require__.bind(null, 35))]).then(function (proms) {
      return proms[0];
    });
  },
  path: function path() {
...
var ___CSS_LOADER_URL___2___ = urlEscape(__webpack_require__(72));
...
var map = {
	"./europify/img/0.jpg": 37,
	"./europify/img/1.jpg": 38,
	"./europify/img/2.mp4": 39,
	"./europify/img/3.jpg": 40,
	"./europify/main.jpg": 22,
	"./projects_information": 13,
	"./projects_information.json": 13,
	"./temp_project/img/0.jpg": 41,
	"./temp_project/img/1.jpg": 42,
	"./temp_project/main.jpg": 23,
	"./temp_project2/img/0.jpg": 43,
	"./temp_project2/img/1.jpg": 44,
	"./temp_project2/main.jpg": 24
};
